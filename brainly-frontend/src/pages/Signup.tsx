      ...
      <div className="relative w-full max-w-md bg-blue-950/30 backdrop-blur-2xl border border-blue-800/30 rounded-3xl p-7 sm:p-9 shadow-2xl shadow-blue-950/60">
        ...
        <div className="flex flex-col items-center gap-4 mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-blue-400/60 text-sm mt-1.5">Store everything. Forget nothing.</p>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className={`w-full bg-blue-950/40 border text-white placeholder-blue-700 rounded-xl px-4 py-3 pr-11 text-sm outline-none transition focus:ring-2 focus:bg-blue-950/60
                  ${passwordsMismatch
                    ? "border-red-500/40 focus:border-red-500/60 focus:ring-red-500/20"
                    : passwordsMatch
                    ? "border-emerald-500/40 focus:border-emerald-500/60 focus:ring-emerald-500/20"
                    : "border-blue-800/40 focus:border-blue-500/60 focus:ring-blue-600/20"
                  }`}
              />
              <button
                type="button"
        ...
        <p className="text-center text-blue-700 text-sm">
          ...
          <a href="/signin" className="text-blue-400 hover:text-blue-300 font-semibold transition">
            Sign in
          </a>
        </p>
      </div>
